...
const Profile = () => {
  ...
  const {email:savedEmail,user_metadata:savedUserData} = useSelector((state)=>state.auth.user)
...
const { data, error } = await supabase.auth.updateUser({email,password,data: { fullname }})
  };
    ...
    <div className="profile_container">
      <Flex gap={"middle"} className="profile_content">
        ...
        <Flex vertical gap={"middle"}>
          ...
          <Button onClick={showModal} type="primary" className="edit_profile_btn">
            Edit Profile
          </Button> 
